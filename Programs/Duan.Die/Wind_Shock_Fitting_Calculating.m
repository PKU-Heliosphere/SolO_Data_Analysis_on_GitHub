...
% hour_beg = 0; min_beg = 30; sec_beg = 0; time_beg = datenum(year,month,day,hour_beg,min_beg,sec_beg);
% hour_end = 1; min_end = 00; sec_end = 0; time_end = datenum(year,month,day,hour_end,min_end,sec_end);

date_str = '20030401';
year = str2num(date_str(1:4)); month = str2num(date_str(5:6)); day = str2num(date_str(7:8));
hour_beg = 2; min_beg = 10; sec_beg = 0; time_beg = datenum(year,month,day,hour_beg,min_beg,sec_beg);
hour_end = 2; min_end = 20; sec_end = 0; time_end = datenum(year,month,day,hour_end,min_end,sec_end);
...
magdir = [solodir 'wi_h2_mfi_' date_str '_v05.cdf'];
if ~isfile(magdir)
    magdir = [solodir 'solo_l2_mag-rtn-normal_' date_str '_v01.cdf'];
end
pmomdir = [solodir 'wi_pm_3dp_' date_str '_v03.cdf'];
...
B_rtn = double(spdfcdfread(magdir,'Variables',{'BGSE'}));
epochp = spdfcdfread(pmomdir,'Variables',{'Epoch'});
np = spdfcdfread(pmomdir,'Variables',{'P_DENS'});
vp = spdfcdfread(pmomdir,'Variables',{'P_VELS'});
Pp = spdfcdfread(pmomdir,'Variables',{'P_TENS'});
Tp = spdfcdfread(pmomdir,'Variables',{'P_TEMP'});
...
%int_before = 80:90; int_after = 150:160; %DC1
%int_before = 220:223; int_after = 229:232; %Feng 2002 case
int_before = 60:70; int_after= 106:116; %DC3
%int_before = 250:260; int_after = 273:283; %DC4
%    int_before = 270:280; int_after = 295:305; %DC4
