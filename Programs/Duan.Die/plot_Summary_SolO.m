...
hour_beg = 22; min_beg = 30; sec_beg = 0; time_beg = datenum(year,month,day,hour_beg,min_beg,sec_beg);
hour_end = 23; min_end = 20; sec_end = 0; time_end = datenum(year,month,day,hour_end,min_end,sec_end);
