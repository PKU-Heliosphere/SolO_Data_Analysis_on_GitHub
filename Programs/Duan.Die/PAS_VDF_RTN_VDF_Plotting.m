...
close all
 %% plot VDF slice || B0    
 VDFrtn
    [alpha_vt_max,alpha_vr_max, alpha_vn_max]=ind2sub([ngridt,ngridr,ngridn], find(VDFrtn==max(VDFrtn(vrnn>500),[],'all')));
    is_lin_log = 1;
...
axis tight
    ...
    saveas(f5,[savedir '\2D_VDF_mfa_' datestr(epoch(ttime),'yyyymmdd_HHMMSS.fff') '.png'])
